...
i1='cbseprivate777'
i2='ronaldinhojay345@gmail.com'
i3='rerat78822@insgogc.com'
i4='zot79130@cuoly.com'
i5=''
...
id1=id_m
id2=str('41354141')
file_of_base=open(r'base.txt')
xzs=file_of_base.read()
file_of_base.close()
base=int(xzs)
new_base=1
...
class Twitterbot:  
    ...
    def draft(self,tweet,base,no_of_tweets,new_base):  
        ...
        for n in range(no_of_tweets):
            ...
            time.sleep(1.5)
            try:
                write=bot.find_element_by_xpath(
            ...
            try:
                write=bot.find_element_by_xpath(
                '//*[@id="layers"]/div[2]/div/div/div/div/div/div[2]/div[2]/div/div[3]/div/div/div/div[1]/div/div/div/div/div[2]/div[1]/div/div/div/div/div/div/div/div/div/label/div[1]/div/div/div/div/div[2]/div/div/div/div'
                ).send_keys(draft)
            ...
            time.sleep(1.5)
            try:
                cross=bot.find_element_by_xpath(
